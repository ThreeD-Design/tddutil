# tddutil [![NPM Version][npm-image]][npm-url] [![NPM Downloads][downloads-image]][downloads-url] [![size-image]][size-url]
...
<!-- 相关介绍：[【总结】做一个自己的前端js工具库](https://juejin.im/post/5daebab45188250ec90be71b "tddutil") -->
## 使用方式
注：为简化操作，默认命名为"tdl"
